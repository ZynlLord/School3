...
@Composable
fun AccountSettings(navController: NavHostController, viewModel: MainViewModel) {
    TopSettingsAccountBar(navController = navController)
}

@Composable
fun TopSettingsAccountBar(
    navController: NavController
) {
    TopAppBar(
        title = {
            Text(text = "Настройки аккаунта")
        },
        navigationIcon = {
            IconButton(onClick = {
